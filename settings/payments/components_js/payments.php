<script type="text/javascript">
	<?php
	ob_start();
	include get_stylesheet_directory() . '/settings/payments/components/payments.php';
        ...
        data: function () {
            return {
                ...
                payments: {
                    payme: {
                        enabled: '',
                        name: "<?php esc_html_e('Payme', 'masterstudy-child'); ?>",
                        fields: {
                            merchant_id: {
                                type: 'text',
                                placeholder: '<?php esc_html_e('Merchant ID', 'masterstudy-child'); ?>',
                                description: {
                                    type: 'textarea',
                                    placeholder: '<?php esc_html_e('Obtain and set Merchant ID from the Paycom Merchant Cabinet', 'masterstudy-child'); ?>'
                                },
                            },
                            merchant_key: {
                                type: 'text',
                                placeholder: '<?php esc_html_e('KEY', 'masterstudy-child'); ?>',
                                description: {
                                    type: 'textarea',
                                    placeholder: '<?php esc_html_e('Obtain and set KEY from the Paycom Merchant Cabinet', 'masterstudy-child'); ?>'
                                },
                            },
                            checkout_url: {
                                type: 'text',
                                placeholder: '<?php esc_html_e('Checkout URL', 'masterstudy-child'); ?>',
                                description: {
                                    type: 'textarea',
                                    placeholder: '<?php esc_html_e('Set Paycom Checkout URL to submit a payment', 'masterstudy-child'); ?>'
                                },
                                default: 'https://checkout.paycom.uz'
                            },
                            return_url: {
                                type: 'text',
                                placeholder: '<?php esc_html_e('Return URL', 'masterstudy-child'); ?>',
                                description: {
                                    type: 'textarea',
                                    placeholder: '<?php esc_html_e('Set Paycom return URL', 'masterstudy-child'); ?>'
                                },
                                default: '<?php echo site_url('/cart/?payme_success=1') ?>'
                            },
                            currency_code: {
                                type: 'select',
                                source: 'codes',
                                value: 'UZS',
                                placeholder: '<?php esc_html_e('Currency code', 'masterstudy-child'); ?>'
                            },
                            description: {
                                type: 'textarea',
                                placeholder: '<?php esc_html_e('Payment method description', 'masterstudy-child'); ?>'
                            },
                        },
                    },
                    click: {
                        enabled: '',
                        name: "<?php esc_html_e('Click', 'masterstudy-child'); ?>",
                        fields: {
                            ...
                            merchant_id: {
                                ...
                                description: {
                                    type: 'textarea',
                                    placeholder: '<?php esc_html_e('Obtain and set Merchant ID from the Merchant Cabinet', 'masterstudy-child'); ?>'
                                },
                            },
                            merchant_user_id: {
                                type: 'text',
                                placeholder: '<?php esc_html_e('Merchant User ID', 'masterstudy-child'); ?>',
                                description: {
                                    type: 'textarea',
                                    placeholder: '<?php esc_html_e('Obtain and set Merchant User ID from the Merchant Cabinet', 'masterstudy-child'); ?>'
                                },
                            },
                            merchant_service_id: {
                                type: 'text',
                                placeholder: '<?php esc_html_e('Merchant Service ID', 'masterstudy-child'); ?>',
                                description: {
                                    type: 'textarea',
                                    placeholder: '<?php esc_html_e('Obtain and set Merchant Service ID from the Merchant Cabinet', 'masterstudy-child'); ?>'
                                },
                            },

                            secret_key: {
                                type: 'text',
                                placeholder: '<?php esc_html_e('Secret Key', 'masterstudy-child'); ?>',
                                description: {
                                    type: 'textarea',
                ...
                sources: {
                    codes: {
                        ...
                        '<?php esc_html_e('So`m', 'masterstudy-child'); ?>': 'UZS',
            ...
            setPaymentValues() {
                ...
                for (var payment_method in vm.payments) {
                    ...
                    for (var field_name in vm.payments[payment_method]['fields']) {
                        if (vm.saved_payments[payment_method]['fields'][field_name]) {
                            vm.$set(vm.payments[payment_method]['fields'][field_name], 'value', vm.saved_payments[payment_method]['fields'][field_name]);
                        } else {
                            vm.$set(vm.payments[payment_method]['fields'][field_name], 'value', vm.payments[payment_method]['fields'][field_name]['default']);
                        }
                    }
                }
            },
